        ...
        public void open(UsbDeviceConnection connection) throws IOException {
            ...
            try {
                for (int i = 0; i < mDevice.getInterfaceCount(); i++) {
                    ...
                    Log.d(TAG,"usbIface name = "+usbIface.toString());
                    if(usbIface.getName().equals("Enhanced Com Port") || usbIface.getName().equals("Standard Com Port")){
                        Log.d(TAG,"no need claim com port");
                        continue;
                    }
