...
public class Constant {
	...
	// 锁控版
//	 public static String COM_LOCKER = "/dev/ttyUSB0";
	public final static int LOCKER_baudrate = 9600;
	public static String COM_LOCKER = "/dev/ttymxc4";
	...
	public static final int ACTION_GETCURRENTTEMP = 20;//add by yazhou

	/**
	 * byte[]转16进制字符串
	 * @return
	 */
	public static String byteToHex(String string, int length, byte[] msg) {
...
//		writeLog(string + sb.toString());
	...
	public static void writeLog(String string) {
		...
		if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
			String path = "/storage/sdcard0/rocktech_log";
			...
			try {
				...
				oStreamWriter.append(dateFormat.format(new Date(System.currentTimeMillis())) + ":" + string + "\n");
				oStreamWriter.flush();
				oStreamWriter.close();
