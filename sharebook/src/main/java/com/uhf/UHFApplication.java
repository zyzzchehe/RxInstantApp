...
import com.rocktech.sharebookcase.tool.CustomExceptionHandler;
import com.rocktech.sharebookcase.tool.SpHelper;
import com.tools.LogcatHelper;
import com.tools.OtgStreamManage;
...
public class UHFApplication extends Application {
	...
	public void onCreate() {
		...
		//捕捉崩溃日志
		CustomExceptionHandler.registerInstance(mContext);
